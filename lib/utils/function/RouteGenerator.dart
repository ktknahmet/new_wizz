...
import 'package:wizzsales/adminPage/adminCommission/commission.dart';
...
import 'package:wizzsales/adminPage/adminCommission/editCommissionRate.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case '/${PageName.adminStockPages}':
        return MaterialPageRoute(builder: (_) =>   StockPage("stock".tr()));
