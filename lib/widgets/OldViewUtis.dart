...
class ViewUtil{
  static List<DistributorSubType> leadtype = [];
  static List<DistributorSubType> downtype = [];
  static List<DistributorSubType> finance = [];

  static showCustomDialog(BuildContext context, Widget bodyWidget) {
