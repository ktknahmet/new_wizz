...
import 'package:wizzsales/widgets/multiSelect/chip_display/multi_select_chip_display.dart';
  ...
  MultiSelectBottomSheetField({
    ...
    this.autovalidateMode = AutovalidateMode.disabled,
            ...
            builder: (FormFieldState<List<V>>? state) {
              ...
              return _MultiSelectBottomSheetFieldView<dynamic>._withState(
                  view, state!);
            });
}
...
class _MultiSelectBottomSheetFieldView<V> extends StatefulWidget {
  ...
  _MultiSelectBottomSheetFieldView._withState(
      _MultiSelectBottomSheetFieldView<V> field, FormFieldState<List<V>> this.state)
      : items = field.items,
        title = field.title,
...
class __MultiSelectBottomSheetFieldViewState<V>
  ...
  Widget _buildInheritedChipDisplay() {
    ...
    chipDisplayItems = _selectedItems
        .map((e) => widget.items!
            .firstWhere((element) => e == element.value))
        .toList();
