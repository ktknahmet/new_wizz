...
class MultiSelectDialog<V> extends StatefulWidget {
   List<MultiSelectDialogItem<V>>? items = [];
      ...
      if (checked) {
        if (itemValue == "TÜMÜ") {
          for (var element in widget.items ?? []) {
            if (!_selectedValues.contains(element.value)) {
              _selectedValues.add(element.value);
            }
          }
        } else {
        ...
        if (itemValue == "TÜMÜ") {
          ...
          if (_selectedValues.contains("TÜMÜ")) {
            _selectedValues.remove("TÜMÜ");
          }
