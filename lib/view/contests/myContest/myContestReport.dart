...
class MyContestReport extends StatefulWidget {
  final String? appBarName;
  final Cont? detailComp;
  final List<CompetitionsReports?>? qualifiedAssocList;
  const MyContestReport(this.appBarName,this.detailComp,this.qualifiedAssocList,{super.key});

  @override
  State<MyContestReport> createState() => _MyContestReportState();
}

class _MyContestReportState extends State<MyContestReport> {
            ...
            children: [
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: (){
                      showPhoto(context, widget.detailComp!.image!);
                    },
                    child: SizedBox(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("${widget.detailComp!.startTime!}-${widget.detailComp!.endTime!}",style: CustomTextStyle().semiBold12(ColorUtil().getColor(context,ColorEnums.textTitleLight)),),
                  ...
                  //Expanded(flex: 3, child: compDetail()),
                ],
              ),
              const SizedBox(
                height: 20,
