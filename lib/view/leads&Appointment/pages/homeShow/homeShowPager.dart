...
class HomeShowPager extends StatefulWidget {
  String questions = "";
  HomeShowPager({super.key, required this.questions});

  @override
  State<HomeShowPager> createState() => _HomeShowPagerState();
}

class _HomeShowPagerState extends State<HomeShowPager> {
  int _customCounter = 0;
  final int _stepCount = 5;
  Size? size;
  List<Widget> pages = [];
  String totalPageCount = "5";
  @override
  void initState() {
    super.initState();
    ...
    pages = [
      ...
      QuestionRangePickerStep(continueClick: _incrementCustomStepper, previousClick: _decrementCustomStepper, step: "5", totalStepCount: totalPageCount, questions: widget.questions,),
