...
class FreeVacationPager extends StatefulWidget {
  final String? questions;
  const FreeVacationPager({super.key,this.questions});

  @override
  State<FreeVacationPager> createState() => _FreeVacationPagerState();
}

class _FreeVacationPagerState extends State<FreeVacationPager> {
