...
class DoorCardPager extends StatefulWidget {
  final String? questions;
  const DoorCardPager({super.key, this.questions});

  @override
  State<DoorCardPager> createState() => _DoorCardPagerState();
}

class _DoorCardPagerState extends State<DoorCardPager> {
