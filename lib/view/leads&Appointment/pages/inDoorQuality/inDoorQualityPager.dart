...
import 'package:wizzsales/view/leads&Appointment/step/questionRangePickerStep.dart';
import 'package:wizzsales/view/leads&Appointment/step/questionWriteStep.dart';
import 'package:wizzsales/view/leads&Appointment/step/questionsStep.dart';
import 'package:wizzsales/widgets/Constant.dart';
import 'package:wizzsales/widgets/Extension.dart';

class InDoorQualityPager extends StatefulWidget {
  String questions = "";
   InDoorQualityPager({super.key, required this.questions});

  @override
  State<InDoorQualityPager> createState() => _InDoorQualityPagerState();
}

class _InDoorQualityPagerState extends State<InDoorQualityPager> {
  int _customCounter = 0;
  final int _stepCount = 5;
  Size? size;
  List<Widget> pages = [];
  String totalPageCount = "6";
  @override
  void initState() {
    super.initState();
    ...
    pages = [
      ...
      QuestionWriteStep(continueClick: _incrementCustomStepper, previousClick: _decrementCustomStepper, step: "5", totalStepCount: totalPageCount, questions: widget.questions,),
      QuestionRangePickerStep(continueClick: _incrementCustomStepper, previousClick: _decrementCustomStepper, step: "6", totalStepCount: totalPageCount, questions: widget.questions,),
