...
class NewReferralPager extends StatefulWidget {
  String questions = "";
  NewReferralPager({super.key, required this.questions});


  @override
  State<NewReferralPager> createState() => _NewReferralPagerState();
}

class _NewReferralPagerState extends State<NewReferralPager> {
  ...
  void initState() {
    ...
    pages = [
      ...
      QuestionsStep(continueClick: _incrementCustomStepper, previousClick: _decrementCustomStepper, step: "2", totalStepCount: totalPageCount, questions: widget.questions,),
