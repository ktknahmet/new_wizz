...
class RegistrationBoxPager extends StatefulWidget {
  String questions = "";
  RegistrationBoxPager({super.key, required this.questions});


  @override
  State<RegistrationBoxPager> createState() => _RegistrationBoxPagerState();
}

class _RegistrationBoxPagerState extends State<RegistrationBoxPager> {
