...
class _SaleDetailsState extends State<SaleDetails> {
                ...
                child: Column(
                  children: [
                    ...
                    Card(
                      ...
                      child:Column(
                        children: [
                          Text("socialMediaInfo".tr(),style: CustomTextStyle().black14(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Row(
                              children: [
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                children: [
                                                  Text(facebook,style: CustomTextStyle().semiBold12(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),)
                                                ],
                                              ),
                                            ],
                                          ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                children: [
                                                  Text(instagram,style: CustomTextStyle().semiBold12(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),)
                                                ],
                                              ),
                                            ],
                                          ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                children: [
                                                  Text(twitter,style: CustomTextStyle().semiBold12(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),)
                                                ],
                                              ),
                                            ],
                                          ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                children: [
                                                  Text(tiktok,style: CustomTextStyle().semiBold12(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),)
                                                ],
                                              ),
                                            ],
                                          ),
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.end,
                                                  children: [
                                                    Text(youtube,style: CustomTextStyle().semiBold12(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),)
                                                  ],
                                                ),
                                              ),
                                            ],
  ...
  Future<void>getList()async{
    ...
    await viewModel.getAccountValue(context,facebook,twitter,instagram,tiktok);

    if(viewModel.socialMedia !=null){
      facebook = viewModel.socialMedia![0].facebook_user_name ?? "";
      twitter= viewModel.socialMedia![0].twitter_user_name ?? "";
      instagram = viewModel.socialMedia![0].instagram_user_name ?? "";
      tiktok = viewModel.socialMedia![0].tiktok_user_name ?? "";
      youtube = "";
    }
