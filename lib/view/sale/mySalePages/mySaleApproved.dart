...
class MySaleApproved extends StatefulWidget {
  const MySaleApproved({super.key});

  @override
  State<MySaleApproved> createState() => _MySaleApprovedState();
}

class _MySaleApprovedState extends State<MySaleApproved> {
        ...
        child: ChangeNotifierProvider.value(
          ...
          child: Consumer<MySaleVm>(
            builder: (context,value,_){
              if(viewModel.approvedMySale == null){
                        ...
                        child: SizedBox(
                          ...
                          child: TextField(
                            onChanged: (value){
                              ...
                              viewModel.searchSale(viewModel.approvedMySale!.data!,viewModel.query);
                            },
                        ...
                        child: RawScrollbar(
                          ...
                          child: SizedBox(
                            ...
                            child: ListView.builder(
                              controller: controller,
                              itemCount:  viewModel.searchSale(viewModel.approvedMySale!.data!,viewModel.query).length,
                              itemBuilder: (context,index){
                                Sale item =  viewModel.searchSale(viewModel.approvedMySale!.data!,viewModel.query)[index];
                                int startIndex = (viewModel.approvedMySale!.total! == 1) ? viewModel.approvedMySale!.total! : viewModel.approvedMySale!.total! - ((viewModel.page - 1) * 15);
  ...
  Future<void> getList()async{
    await viewModel.getApprovedMySale(context,viewModel.page);
    viewModel.pageCount.clear();
    if(viewModel.approvedMySale !=null){
      for(int i=0;i<viewModel.approvedMySale!.last_page!;i++){
