...
class SerialStep extends StatefulWidget {
  final VoidCallback? continueClick;
  final String? step;
  final String? totalStepCount;
  const SerialStep({super.key, required this.continueClick,this.step, this.totalStepCount});

  @override
  State<SerialStep> createState() => _SerialStepState();
}

class _SerialStepState extends State<SerialStep> {
