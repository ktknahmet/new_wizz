...
class MyProgress extends BaseStatefulPage {
  const MyProgress(super.appBarName, {super.key});
...
class _MyProgressState extends BaseStatefulPageState<MyProgress> {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8,),
                                    Text(
                                      "${viewModel.successSold}/${viewModel.totalDemos.toString()} (${getDecimalPlaces(viewModel.closingRatio ?? 0.00, 2)}%)",
                                      style: CustomTextStyle().regular12(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),
                                    ),
                                  ],
                                ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8,),
                                    Text(
                                      "${viewModel.appointmentActual}/${viewModel.appointmentGoals ?? 0}",
                                      style: CustomTextStyle().regular12(ColorUtil().getColor(context, ColorEnums.textDefaultLight)),
                                    ),
                                  ],
                                ),
