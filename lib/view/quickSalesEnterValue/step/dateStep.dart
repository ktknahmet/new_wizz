...
class DateStep extends StatefulWidget {
  ...
  const DateStep({super.key, required this.continueClick,this.previousClick,this.step, this.totalStepCount});
      ...
      child: Column(
        children: [
          ...
          TextField(
            ...
            readOnly: true,
            onTap: () async{
              startDate.text = await DatePickerHelper.getDatePicker2(context);
            },
          ),
          const SizedBox(height: 8,),
          Padding(
