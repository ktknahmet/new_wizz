...
class PriceInfoStep extends StatefulWidget {
  ...
  const PriceInfoStep({super.key,this.page, required this.continueClick,this.step, this.totalStepCount});

  @override
  State<PriceInfoStep> createState() => _PriceInfoStepState();
}

class _PriceInfoStepState extends State<PriceInfoStep> {
