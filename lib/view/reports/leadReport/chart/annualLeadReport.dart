...
class AnnualLeadChart extends StatefulWidget {
  const AnnualLeadChart({super.key});


  @override
  State<AnnualLeadChart> createState() => _AnnualLeadChartState();
}

class _AnnualLeadChartState extends State<AnnualLeadChart> {
    ...
    if(viewModel.detailsReportModel !=null){
      ...
      for(int i =0;i<viewModel.detailsReportModel!.leadsReport!.leadReports!.length;i++){
        if(chooseLead[i]==leadType){
          total = viewModel.detailsReportModel!.leadsReport!.leadReports![i].annualyAppointmentSet!+viewModel.detailsReportModel!.leadsReport!.leadReports![i].annualySold!+viewModel.detailsReportModel!.leadsReport!.leadReports![i].annualyNotContacted!;
          leadModel.add(DemoLeadReportModel("appointmentSet", viewModel.detailsReportModel!.leadsReport!.leadReports![i].annualyAppointmentSet ?? 0));
          leadModel.add(DemoLeadReportModel("sold", viewModel.detailsReportModel!.leadsReport!.leadReports![i].annualySold ?? 0));
          leadModel.add(DemoLeadReportModel("notContacted",viewModel.detailsReportModel!.leadsReport!.leadReports![i].annualyNotContacted ?? 0));
