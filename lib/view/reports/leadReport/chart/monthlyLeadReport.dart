...
class MonthlyLeadChart extends StatefulWidget {
  const MonthlyLeadChart({super.key});


  @override
  State<MonthlyLeadChart> createState() => _MonthlyLeadChartState();
}

class _MonthlyLeadChartState extends State<MonthlyLeadChart> {
    ...
    if(viewModel.detailsReportModel !=null){
      ...
      for(int i =0;i<viewModel.detailsReportModel!.leadsReport!.leadReports!.length;i++){
        if(chooseLead[i]==leadType){
          total = viewModel.detailsReportModel!.leadsReport!.leadReports![i].monthlyAppointmentSet!+viewModel.detailsReportModel!.leadsReport!.leadReports![i].monthlySaleSold!+viewModel.detailsReportModel!.leadsReport!.leadReports![i].monthlyNotContacted!;
          leadModel.add(DemoLeadReportModel("appointmentSet", viewModel.detailsReportModel!.leadsReport!.leadReports![i].monthlyAppointmentSet ?? 0));
          leadModel.add(DemoLeadReportModel("sold", viewModel.detailsReportModel!.leadsReport!.leadReports![i].monthlySaleSold ?? 0));
          leadModel.add(DemoLeadReportModel("notContacted",viewModel.detailsReportModel!.leadsReport!.leadReports![i].monthlyNotContacted ?? 0));
