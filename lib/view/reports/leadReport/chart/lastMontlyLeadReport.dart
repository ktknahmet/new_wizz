...
class LastMonthlyLeadChart extends StatefulWidget {
  const LastMonthlyLeadChart({super.key});


  @override
  State<LastMonthlyLeadChart> createState() => _LastMonthlyLeadChartState();
}

class _LastMonthlyLeadChartState extends State<LastMonthlyLeadChart> {
    ...
    if(viewModel.detailsReportModel !=null){
      ...
      for(int i =0;i<viewModel.detailsReportModel!.leadsReport!.leadReports!.length;i++){
        if(chooseLead[i]==leadType){
          total = viewModel.detailsReportModel!.leadsReport!.leadReports![i].lastMonthAppointmentSet!+viewModel.detailsReportModel!.leadsReport!.leadReports![i].lastMonthSaleSold!+viewModel.detailsReportModel!.leadsReport!.leadReports![i].lastMonthNotContacted!;
          leadModel.add(DemoLeadReportModel("appointmentSet", viewModel.detailsReportModel!.leadsReport!.leadReports![i].lastMonthAppointmentSet ?? 0));
          leadModel.add(DemoLeadReportModel("sold", viewModel.detailsReportModel!.leadsReport!.leadReports![i].lastMonthSaleSold ?? 0));
          leadModel.add(DemoLeadReportModel("notContacted",viewModel.detailsReportModel!.leadsReport!.leadReports![i].lastMonthNotContacted ?? 0));
