...
class TotalLeadsReport extends BaseStatefulPage {
  const TotalLeadsReport(super.appBarName, {super.key});

  @override
  State<StatefulWidget> createState() => _TotalLeadsReportState();
}

class _TotalLeadsReportState extends BaseStatefulPageState<TotalLeadsReport> {
