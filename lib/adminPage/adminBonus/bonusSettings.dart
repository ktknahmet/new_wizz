...
class BonusSettings extends BaseStatefulPage {
  const BonusSettings(super.appBarName, {super.key});

  @override
  State<StatefulWidget> createState() => _BonusSettingsState();
}

class _BonusSettingsState extends BaseStatefulPageState<BonusSettings> {
