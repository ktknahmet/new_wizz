...
class AdminCustomerApproved extends StatefulWidget {
  final String? type;
  const AdminCustomerApproved(this.type,{super.key});

  @override
  State<AdminCustomerApproved> createState() => _AdminCustomerApprovedState();
}

class _AdminCustomerApprovedState extends State<AdminCustomerApproved> {
