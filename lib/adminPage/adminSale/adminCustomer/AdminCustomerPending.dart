...
class AdminCustomerPending extends StatefulWidget {
  final String? type;
  const AdminCustomerPending(this.type,{super.key});

  @override
  State<AdminCustomerPending> createState() => _AdminCustomerPendingState();
}

class _AdminCustomerPendingState extends State<AdminCustomerPending> {
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: GestureDetector(
                                                      onTap: () async{
                                                        await updateStatusOfficeSale(context, viewModel, item.serialid!, item.id!,getList);
                                                      },
