...
class AdminCustomerCancel extends StatefulWidget {
  final String? type;
  const AdminCustomerCancel(this.type,{super.key});

  @override
  State<AdminCustomerCancel> createState() => _AdminCustomerCancelState();
}

class _AdminCustomerCancelState extends State<AdminCustomerCancel> {
                        ...
                        child: SizedBox(
                          ...
                          child: TextField(
                            onChanged: (value){
                              ...
                              viewModel.searchSale(viewModel.cancelSale!.data!,viewModel.query);
                            },
                        ...
                        child: RawScrollbar(
                          ...
                          child: SizedBox(
                            ...
                            child: ListView.builder(
                              controller: controller,
                              itemCount: viewModel.searchSale(viewModel.cancelSale!.data!,viewModel.query).length,
                              itemBuilder: (context,index){
                                Sale item = viewModel.searchSale(viewModel.cancelSale!.data!,viewModel.query)[index];
                                int startIndex = (viewModel.cancelSale!.total! == 1) ? viewModel.cancelSale!.total! : viewModel.cancelSale!.total! - ((viewModel.page - 1) * 15);
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: GestureDetector(
                                                      onTap: () async{
                                                        await updateStatusApproveCancel(context, viewModel, item.serialid!, item.id!,getList);
                                                        await getList();
                                                      },
  ...
  Future<void> getList()async{
    await viewModel.getCancelSale(context,viewModel.page);
    viewModel.pageCount.clear();
    if(viewModel.cancelSale !=null){
      print("boyut :${viewModel.cancelSale!.total!}");
      for(int i=0;i<viewModel.cancelSale!.last_page!;i++){
