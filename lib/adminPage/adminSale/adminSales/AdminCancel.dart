...
class AdminCancel extends StatefulWidget {
  final String? type;
  const AdminCancel(this.type,{super.key});

  @override
  State<AdminCancel> createState() => _AdminCancelState();
}

class _AdminCancelState extends State<AdminCancel> {
